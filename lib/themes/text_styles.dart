...
class AppTextStyles {
  ...
  static TextStyle get darkDisplayLarge => lightDisplayLarge.copyWith(
        color: AppColors.darkTextPrimary,
      );

  static TextStyle get darkDisplayMedium => lightDisplayMedium.copyWith(
        color: AppColors.darkTextPrimary,
      );

  static TextStyle get darkDisplaySmall => lightDisplaySmall.copyWith(
        color: AppColors.darkTextPrimary,
      );

  static TextStyle get darkHeadlineLarge => lightHeadlineLarge.copyWith(
        color: AppColors.darkTextPrimary,
      );

  static TextStyle get darkHeadlineMedium => lightHeadlineMedium.copyWith(
        color: AppColors.darkTextPrimary,
      );

  static TextStyle get darkHeadlineSmall => lightHeadlineSmall.copyWith(
        color: AppColors.darkTextPrimary,
      );

  static TextStyle get darkBodyLarge => lightBodyLarge.copyWith(
        color: AppColors.darkTextPrimary,
      );

  static TextStyle get darkBodyMedium => lightBodyMedium.copyWith(
        color: AppColors.darkTextPrimary,
      );

  static TextStyle get darkBodySmall => lightBodySmall.copyWith(
        color: AppColors.darkTextSecondary,
      );

  static TextStyle get darkLabelLarge => lightLabelLarge.copyWith(
        color: AppColors.darkTextSecondary,
      );

  static TextStyle get darkLabelMedium => lightLabelMedium.copyWith(
        color: AppColors.darkTextSecondary,
      );

  static TextStyle get darkLabelSmall => lightLabelSmall.copyWith(
        color: AppColors.darkTextSecondary,
      );
}
