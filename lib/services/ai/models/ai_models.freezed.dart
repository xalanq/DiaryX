...
mixin _$AIServiceStatus {
  ...
  Map<String, dynamic>? get llmBackend => throw _privateConstructorUsedError;
  Map<String, dynamic>? get metadata => throw _privateConstructorUsedError;

  /// Serializes this AIServiceStatus to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AIServiceStatus
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
...
abstract class $AIServiceStatusCopyWith<$Res> {
  factory $AIServiceStatusCopyWith(
    ...
    $Res Function(AIServiceStatus) then,
      ...
      _value.copyWith(
            ...
            error: freezed == error
                ...
                : error // ignore: cast_nullable_to_non_nullable
                      as String?,
            llmBackend: freezed == llmBackend
                ? _value.llmBackend
                : llmBackend // ignore: cast_nullable_to_non_nullable
                      as Map<String, dynamic>?,
...
abstract class _$$AIServiceStatusImplCopyWith<$Res>
    implements $AIServiceStatusCopyWith<$Res> {
  factory _$$AIServiceStatusImplCopyWith(
    _$AIServiceStatusImpl value,
...
class __$$AIServiceStatusImplCopyWithImpl<$Res>
  ...
  __$$AIServiceStatusImplCopyWithImpl(
    _$AIServiceStatusImpl _value,
    $Res Function(_$AIServiceStatusImpl) _then,
  ) : super(_value, _then);
...
class _$AIServiceStatusImpl implements _AIServiceStatus {
  const _$AIServiceStatusImpl({
    ...
    this.version,
    this.error,
    final Map<String, dynamic>? llmBackend,
  ...
  @override
  final String? error;
  final Map<String, dynamic>? _llmBackend;
  @override
  Map<String, dynamic>? get llmBackend {
    final value = _llmBackend;
    if (value == null) return null;
    if (_llmBackend is EqualUnmodifiableMapView) return _llmBackend;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }
  ...
  @override
  String toString() {
    return 'AIServiceStatus(serviceName: $serviceName, status: $status, capabilities: $capabilities, timestamp: $timestamp, version: $version, error: $error, llmBackend: $llmBackend, metadata: $metadata)';
  }
  ...
  int get hashCode => Object.hash(
    ...
    version,
    error,
    const DeepCollectionEquality().hash(_llmBackend),
    const DeepCollectionEquality().hash(_metadata),
  );
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$AIServiceStatusImplToJson(this);
  }
}
